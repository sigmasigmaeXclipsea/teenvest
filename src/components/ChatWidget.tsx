...
const ChatWidget = () => {
  ...
  const [messages, setMessages] = useState<Message[]>([
    { 
      role: 'assistant', 
      content: "Hey! 👋 I'm TeenVest AI, your friendly investing buddy! Ask me anything about stocks, your portfolio, or how to become a smarter investor. What would you like to learn today?" 
    },
  ]);
  ...
  return (
    ...
    >
      {/* Header */}
      <div className="flex items-center justify-between p-3 border-b bg-primary/5 rounded-t-2xl">
        <div className="flex items-center gap-2">
          <div className="w-8 h-8 rounded-full bg-primary flex items-center justify-center">
            <Bot className="w-5 h-5 text-primary-foreground" />
          </div>
          <div>
            <p className="font-semibold text-sm">TeenVest AI</p>
            {!isMinimized && (
              <p className="text-xs text-muted-foreground">Your investing buddy</p>
            )}
          </div>
        </div>
